...
import (
	...
	"github.com/haproxytech/go-licenses/v2/internal/third_party/pkgsite/source"
)
...
func TestLibraries(t *testing.T) {
	...
	for _, test := range []struct {
	...
	}{
		{
			...
			importPath: "github.com/haproxytech/go-licenses/v2/licenses/testdata/direct",
			wantLibs:   []wantedLibInfo{directLibInfo, indirectLibInfo},
		},
		{
			desc:       "Detects transitive dependency",
			importPath: "github.com/haproxytech/go-licenses/v2/licenses/testdata",
		...
		},
		{
			...
			importPath: "github.com/haproxytech/go-licenses/v2/licenses/testdata",
			ignore: []string{
				"github.com/haproxytech/go-licenses/v2/licenses/testdata/direct",
			},
			wantLibs: []wantedLibInfo{testdataLibInfo, indirectLibInfo},
		},
		{
			desc:         "Detects the dependencies only imported in testing code",
			importPath:   "github.com/haproxytech/go-licenses/v2/licenses/testdata/testlib",
			includeTests: true,
			wantLibs: []wantedLibInfo{
				indirectLibInfo,
				{
					Name:        "github.com/haproxytech/go-licenses/v2/licenses/testdata/testlib",
					LicenseFile: wd + "/testdata/LICENSE",
					Licenses:    classifier.licenses["testdata/LICENSE"],
				},
			},
		...
		},
		{
			...
			importPath: "github.com/haproxytech/go-licenses/v2/licenses/testdata/tags",
			goflags:    "-tags=tags",
			wantLibs: []wantedLibInfo{
				indirectLibInfo,
				{
					Name:        "github.com/haproxytech/go-licenses/v2/licenses/testdata/tags",
					LicenseFile: wd + "/testdata/LICENSE",
					Licenses:    classifier.licenses["testdata/LICENSE"],
				},
			},
